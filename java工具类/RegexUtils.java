...
public final class RegexUtils {
    ...
    public static boolean isURL(String string) {
        return isMatch(RegexConstants.REGEX_URL_TWO, string);
    }
    /**
    ...
    public static boolean isBANKCARD(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_ID_BANDCARDS, input);
    }
    public static boolean isExpiredDate(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_ID_EXPIREDATE, input);
    }

    public static boolean isData(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_ID_DATA, input);
    }
