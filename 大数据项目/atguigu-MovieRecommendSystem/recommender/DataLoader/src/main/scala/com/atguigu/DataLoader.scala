...
/**
  * @Auther Tom
  * @Date 2020-04-23 22:32
  * @描述 第一步: 加载数据到mongdb和ES中
  */
...
object DataLoader {
  // 定义常量
  val MOVIE_DATA_PATH = "./大数据项目/atguigui-MovieRecommendSystem/recommender/DataLoader/src/main/resources/movies.csv"
  val RATING_DATA_PATH = "./大数据项目/atguigui-MovieRecommendSystem/recommender/DataLoader/src/main/resources/ratings.csv"
  val TAG_DATA_PATH = "./大数据项目/atguigui-MovieRecommendSystem/recommender/DataLoader/src/main/resources/main/resources/tags.csv"
